...
async def txt_handler(bot: Client, m: Message):  
    ...
    f"\n\n<b>🎓  Uᴘʟᴏᴀᴅ Bʏ : {CR}</b>"
                ...
                if "drive" in url:
                    ...
                    # Utkarsh specific domain replacement for PDF
                    ...
                    try:
                        ...
                        # PDF Downloader using requests (Better for Utkarsh/S3)
                        pdf_path = f"{name}.pdf"
                        ...
                        if response.status_code == 200:
                            ...
                            # Fallback to yt-dlp if requests fail
                            os.system(f'yt-dlp -o "{pdf_path}" "{url}"')
                        ...
                        failed_count += 1
                        if 'prog' in locals(): await prog.delete()
