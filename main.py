...
async def txt_handler(bot: Client, m: Message):  
    ...
    f"\n\n<b>🎓  Uᴘʟᴏᴀᴅ Bʏ : {CR}</b>"
                ...
                if "drive" in url:
                    ...
                    # ────────────────────────────────────────────────
                    #          Utkarsh / other CloudFront fixes
                    # ────────────────────────────────────────────────
                    ...
                    try:
                        ...
                        # ─── Try cloudscraper first (good against Cloudflare) ───
                        try:
                            ...
                            response = scraper.get(url, headers=headers, timeout=90, stream=True)
